                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form method="POST" id="myForm" action = "">
                            <input type="hidden" name="idcategorie" id ="idcategorie" value="<?php echo $categorie['idcategorie']; ?>">
                            
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="type" name="type"placeholder="type" value="<?php echo $categorie['type']; ?>">
                                <label for="floatingText">type</label>
                            </div>
                    
                            <button type="submit" class="btn btn-primary py-3 w-100 mb-4">Update categorie</button>
                        </form>
                    </div>
                </div>
            </div>
